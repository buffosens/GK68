webpackJsonp([0, 3, 5, 7, 12, 14], {
            ...
            methods: {
                ...
                moveHuePos: function(e) {
                    ...
                    if (t.colorbarmousedown) {
                        var i = e.currentTarget.parentNode.parentNode,
                            o = i.querySelector(".color-current"),
                ...
                resetColor: function() {
                    var e = this,
                        ...
                        i = 100 * (1 - this.colorboxposright / e.hueh),
                        o = 100 * (1 - this.colorboxpostop / e.hueh),
                        a = window.fromRGB(window.fromHSB({
                            h: t,
                            s: i,
                            b: o
                        }));
        ...
        t.a = {
            ...
            methods: (o = {
                ...
                showStdBtns: function() {
                    ...
                    var e = $("std_conf_showbox"),
                        t = CMS.deviceConfig.DriverLEKey,
                        i = $("key" + t);
                ...
                handleKeyClick: function(e) {
                    ...
                    var i = !1,
                        o = DEVICE.currentProfile.KeySet;
                ...
                playLe: function() {
                    var e = this,
                        ...
                        a = 0;
                    if (LeData.Canvases)
                        for (var l = 0; l < LeData.Canvases.length; l++)
                            if (LeData.Canvases[l].DeviceTypes.indexOf(CMS.deviceConfig.DeviceType.toString()) >= 0) {
                    ...
                    if (this.hasModeLe || !([2, 3, 4].indexOf(DEVICE.currentProfile) >= 0) || "1" != this.leseltype) {
                        ...
                        DEVICE.isEditStaticLE && i.$refs.lestatic && i.$refs.lestatic.triggerSelLeCode(), e ? (i.filterlelist.forEach(function(a, l) {
                            if (a.GUID === e) {
                                ...
                                var n = i.$refs.lestable.bodyWrapper.scrollHeight,
                                    s = l / o;
    ...
    550: function(e, t, i) {
        ...
        var o = function() {
                ...
                }, e._l(e.precolors, function(t, o) {
                    return i("li", {
                        key: o,
                        class: {
                            selected: e.colorhex == t
                        },
                        style: {
                            backgroundColor: t
                        },
        ...
        var o = function() {
                ...
                return i("div", {
                    ...
                    return 0 == t.LogicCode ? i("div", {
                        ...
                        on: {
                            click: e.switchFnLayer
                        }
                    }) : e._e()
                }), e._v(" "), i("div", {
                    staticClass: "keybox"
                }, e._l(e.showkeymap, function(t) {
                    return e.showbtn && t.LogicCode > 0 ? i("div", {
                        staticClass: "device-key",
                        class: {
                            noshowkeyset: !e.isshowkeyset
                        },
                        style: {
                            left: t.Position.Left + "px",
                            top: t.Position.Top + "px",
                    ...
                    staticClass: "key-func"
                }, [i("tr", [i("td", [e._v(e._s(e.$t("common.key_func")) + " :")]), e._v(" "), i("td", {
                    staticClass: "cval",
                    attrs: {
                        id: "config_key",
                        colspan: "2"
                    ...
                    on: {
                        click: e.handleSelectKeyLE
                    }
                })]), e._v(" "), i("td", [i("i", {
                    staticClass: "el-icon-delete",
                    on: {
                        click: e.handleRemoveLight
                    }
                })])])])]), e._v(" "), i("div", {
                    staticClass: "popper__arrow"
                })]) : e._e(), e._v(" "), e.showstdset ? i("div", {
                    staticClass: "custom el-tooltip__popper is-dark",
                    staticStyle: {
                        padding: "6px"
                    },
                    ...
                    }, [e._v(e._s(t.GUID ? t.Name : e.$t("common.key_le_no_config")))]), e._v(" "), i("i", {
                        staticClass: "el-icon-more-outline warning",
                        on: {
                            click: function(t) {
                ...
                }, [e._v(e._s(e.$t("keys.key_mode_offline_1")))]), e._v(" "), i("el-radio-button", {
                    attrs: {
                        label: "0x0a070003"
                    }
                }, [e._v(e._s(e.$t("keys.key_mode_offline_2")))]), e._v(" "), i("el-radio-button", {
                    attrs: {
                        label: "0x0a070004"
                    }
                }, [e._v(e._s(e.$t("keys.key_mode_offline_3")))])], 1)], 1)]) : e._e()])]), e._v(" "), i("div", {
                    staticClass: "popper__arrow",
                    staticStyle: {
                        left: "2rem"
                    }
                ...
                }, [e._l(e.quickselects, function(t, o) {
                    return i("el-button", {
                        key: o,
                        attrs: {
                            size: "mini"
    ...
    555: function(e, t, i) {
        ...
        var o = function() {
                ...
                return i("el-row", {
                    ...
                    class: {
                        disablehide: 0 == e.mode || e.hasModeLe && [2, 3, 4].indexOf(e.mode) >= 0 || "2" == e.leseltype
                    }
                }), e._v(" "), i("template", {
                    slot: "header"
                }, [i("i", {
                    staticClass: "header-icon el-icon-kb-light3"
                }), e._v("  " + e._s(e.title) + " ( "), i("el-tag", [e._v(e._s(e.lelist.length))]), e._v(" )\n      ")], 1), e._v(" "), e.isstaticle ? i("div", {
                    staticStyle: {
                        width: "100%"
                    },
                    attrs: {
                    ...
                    slot: "prepend"
                }, [e._v(e._s(e.$t("menu.menu_le_lib")))]), e._v(" "), i("el-button", {
                    attrs: {
                        slot: "append",
                        icon: "el-icon-search"
                    },
                    ...
                    scopedSlots: e._u([{
                        key: "default",
                        fn: function(t) {
                            return ["combination" == t.row.LeType ? i("i", {
                                staticClass: "el-icon-kb-cate1"
                            }) : 80 == t.row.LeCate ? i("i", {
                                staticClass: "el-icon-kb-mouse-left"
                            }) : 1760 == t.row.LeCate ? i("i", {
                                staticClass: "el-icon-kb-system"
                            }) : i("i", {
                                staticClass: "el-icon-kb-light1"
                            }), e._v(" "), i("span", {
                                staticStyle: {
                                    "margin-left": "10px"
                                }
                ...
                }, [e._v(e._s(e.$t("common.use")))]), e._v(" "), e._e()], 1) : 2 == e.leseltype ? i("div", {
                    staticStyle: {
    ...
    566: function(e, t, i) {
        ...
        var o = function() {
                ...
                return i("el-row", [i("el-col", {
                    ...
                    staticClass: "disablediv",
                    class: {
                        disablehide: !e.disabled
                    }
                }), e._v(" "), i("template", {
                    slot: "header"
                }, [i("i", {
                    staticClass: "header-icon el-icon-document"
                }), e._v(" " + e._s(e.$t("macro.macro_setting_title")) + "\n      ")]), e._v(" "), i("el-input", {
                    staticClass: "input-with-select",
                    attrs: {
                        placeholder: e.$t("common.input_search_text"),
                        size: "mini"
        ...
        var o = function() {
                ...
                return i("el-row", {
                    ...
                    return i("el-tab-pane", {
                        ...
                        class: t.icon
                    }), e._v(" " + e._s(e.$t("keyset")[t.lang]) + "\r\n          ")]), e._v(" "), e._l(t.keys, function(t) {
                        return i("div", {
                            key: t.index
                        }, e._l(t.linekeys, function(t) {
                            return i("el-button", {
                                key: t.index,
                                staticClass: "key-btn",
                                class: t.Class,
                ...
                }), e._v(" " + e._s(e.$t("common.user_manual")) + "\r\n          ")]), e._v(" "), i("el-tabs", {
                    staticStyle: {
                        height: "200px"
                    },
                    attrs: {
                    ...
                    return i("el-tab-pane", {
                        ...
                        }, [e._v(e._s(t.key))]), e._v(" "), i("i", {
                            staticClass: "el-icon-back"
                        }), e._v("\r\n                " + e._s(e.$t("common")[t.desc_lang]) + "\r\n              ")], 1)
                    }), 0)
                }), 1)], 1)], 2)], 1)], 1), e._v(" "), i("el-row", [i("div", {
                    staticClass: "keyset-foot"
                }, [i("el-form", {
                    attrs: {
                        inline: !0,
                        size: "mini"
                    ...
                    staticClass: "el-icon-kb-windows"
                })]), e._v(" "), i("el-radio-button", {
                    attrs: {
                        label: "Mac"
                    }
                }, [i("i", {
                    staticClass: "el-icon-kb-mac"
                })])], 1)], 1), e._v(" "), i("el-form-item", {
                    attrs: {
                        label: e.$t("common.comb_func")
                    }
                }, [i("el-select", {
                    staticStyle: {
                        width: "10rem"
                ...
                }, [e._v(e._s(e.$t("common.use")))])], 1), e._v(" "), e.isdrivermode ? i("el-form-item", {
                    attrs: {
                        label: e.$t("common.shortcut")
                    }
                }, [i("el-input", {
                    staticStyle: {
                        width: "10rem"
    ...
    572: function(e, t, i) {
        ...
        var o = i(64),
            ...
            d = i(584),
            u = i.n(d),
            m = document.getElementById("mainbox").offsetHeight,
            f = document.getElementById("mainbox").offsetWidth;
            ...
            methods: {
                ...
                changeKeyFunc: function(e, t) {
                    ...
                    if (o = i.isfnkeyset ? DEVICE.currentProfile.FnKeySet : DEVICE.currentProfile.KeySet, "disable_enable" == t) {
                        ...
                        console.log(l);
                        for (var a = 0; a < o.length; a++)
                            if (l.indexOf(o[a].Index.toString()) >= 0) {
                        ...
                        for (var a = 0; a < o.length; a++) o[a].Index === DEVICE.editKeyCode && (o[a].MenuName = e, o[a].DriverValue = t, e.indexOf(".exe") > 0 && (o[a].DriverValue = "0x0A030001", o[a].Task = {}, o[a].Task.Type = "OpenURL", o[a].Task.Data = {
                            AppPath: t
                        }), window.isKeySetChange() ? this.iskeysetchange = !0 : this.iskeysetchange = !1)
                ...
                removeKeyFunc: function() {
                    var e = this,
                        t = $("config_key").getAttribute("data-key"),
                        i = [];
                ...
                removeKeyLE: function() {
                    ...
                    for (var e = $("config_key").getAttribute("data-key"), t = 0; t < DEVICE.currentProfile.KeySet.length; t++)
    ...
    600: function(e, t, i) {
        ...
        var o = function() {
                ...
                return i("el-row", {
                    ...
                    attrs: {
                        effect: "dark",
                        content: e.$t("common.is_restore_current_layer_to_default"),
                        placement: "top"
                    }
                }, [i("el-button", {
                    attrs: {
                    ...
                    attrs: {
                        effect: "dark",
                        content: e.$t("common.is_clear_current_config"),
                        placement: "top"
                    }
                }, [i("el-button", {
                    attrs: {
                    ...
                    on: {
                        click: e.handleShowClearProfile
                    }
                })], 1), e._v(" "), i("el-tooltip", {
                    staticClass: "item",
                    attrs: {
                        effect: "dark",
                        content: e.$t("common.is_import_profile_to_current_layer"),
                        placement: "top"
                    }
                }, [i("el-button", {
                    attrs: {
                        icon: "el-icon-upload2",
                        disabled: e.disimportprofile
                    },
                    on: {
                        click: e.handleImportProfile
                    }
                })], 1), e._v(" "), i("el-tooltip", {
                    staticClass: "item",
                    attrs: {
                        effect: "dark",
                        content: e.$t("common.is_export_current_layer"),
                        placement: "top"
                    }
                }, [i("el-button", {
                    attrs: {
                        icon: "el-icon-download",
                        disabled: e.disexportprofile
                    },
                    on: {
                        click: e.handleExportProfile
                    }
                })], 1)], 1), e._v(" "), i("div", {
                    staticStyle: {
                        position: "absolute",
                    ...
                    staticClass: "devinfo"
                }, [i("span", [e._v(e._s(e.$t("common.model")) + ": ")]), e._v(e._s(e.device.modelInfo.Name)), i("br"), e._v(" "), i("span", [e._v(e._s(e.$t("common.firm_version")) + ": ")]), e._v(e._s(e.device.FWVersion) + "\n        ")]), e._v(" "), i("div", {
                    directives: [{
                        name: "show",
                        rawName: "v-show",
                        value: !1,
                ...
                }), e._v(" " + e._s(e.dialog.title))]), e._v(" "), i("span", [e._v(e._s(e.dialog.content))]), e._v(" "), i("span", {
                ...
                }), e._v(" " + e._s(e.dialogkeylesel.title))]), e._v(" "), i("span", [i("el-table", {
                    ref: "keylestable",
                    attrs: {
                    ...
                    on: {
                        "row-click": e.handleKeyLeRowChange
                    }
                }, [i("el-table-column", {
                    scopedSlots: e._u([{
                        key: "default",
                    ...
                    on: {
                        click: e.handleKeyLeConfirm
                    }
                }, [e._v(e._s(e.$t("common.confirm")))])], 1)])], 1), e._v(" "), i("el-row", {
                    style: {
                        height: e.lay_h_keys + "px"
                    },
                    attrs: {
                        id: "device-keys-box"
                    }
                    ...
                    on: {
                        saveModeLE: e.saveModeLE,
                        playLE: e.playLE
                    }
                })], 1), e._v(" "), i("el-row", {
                    style: {
                        height: e.lay_h_macros + "px"
                    },
                    attrs: {
                        id: "device-macro-box"
                    }
